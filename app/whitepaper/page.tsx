...
export default function Whitepaper() {
    return (
        <div className="min-h-screen bg-[#0A0A0A] font-sans selection:bg-[#FF7F50] selection:text-white text-[#EDEDED] overflow-hidden relative">
            {/* Ambient Brand Glow */}
            {/* Ambient Brand Glow - Increased visibility */}
            <div className="absolute top-0 right-0 w-[800px] h-[600px] bg-[#FF7F50]/[0.08] rounded-full blur-[120px] pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#FF4500]/[0.05] rounded-full blur-[120px] pointer-events-none" />
            {/* Navigation */}
            <nav className="fixed top-0 w-full p-6 flex justify-between items-center z-50 backdrop-blur-md bg-[#050505]/80 border-b border-white/5">
                <Link href="/" aria-label="Back to Home Page" className="font-sans font-medium text-sm tracking-wide text-neutral-400 hover:text-[#FF7F50] flex items-center gap-2 group transition-colors">
                    <ArrowLeft className="w-4 h-4 text-neutral-500 group-hover:text-[#FF7F50] transition-colors" aria-hidden="true" />
                    <span className="group-hover:translate-x-1 transition-transform">Back to Home</span>
                </Link>
                <div className="flex items-center gap-2">
                    <span className="font-sans font-bold text-xl tracking-tighter text-white">iya</span>
                </div>
            </nav>
            ...
            <main className="pt-32 pb-24 px-6 md:px-12 max-w-4xl mx-auto">
                ...
                >
                    <span className="font-mono text-xs text-neutral-400 uppercase tracking-widest mb-4 block">Technical White Paper &bull; v1.0 &bull; January 2026</span>
                    <h1 className="text-4xl md:text-5xl font-medium tracking-tight mb-8">
                        iya: The Immutable "Black Box" Protocol for Autonomous AI Governance
                    </h1>
                    ...
                    <div className="prose prose-invert prose-lg max-w-none text-[#AAAAAA]">
                        ...
                        <p className="mt-4">
                            <strong>iya</strong> provides an immutable audit trail for autonomous AI agents, capturing intent and verifying identity to solve the compliance gap for enterprise agents, ensuring accountability in the age of agentic workflows. By hashing the agent's internal "Chain of Thought" and signing every API output with a verified Identity Key, we create an immutable, forensic audit trail that enables enterprises to deploy autonomous agents with the same rigorous governance standards applied to human employees.
                        </p>
                        ...
                        <ul className="list-disc pl-6 space-y-2 mt-4 text-neutral-400 marker:text-[#FF7F50]">
                        ...
                        <p>
                            iya functions as a middleware "Sidecar" that sits between your agent runner and the external world. It enforces a strict cryptographic lifecycle for every interaction:
                        </p>
                        ...
                        <p className="mt-4 font-mono text-sm bg-white/5 p-4 rounded-lg border border-[#FF7F50]/20">
                        ...
                        <p>
                            Before an agent executes an external tool call, iya captures the internal "Chain of Thought" (the reasoning trace). This textual reasoning is hashed and timestamped.
                        </p>
                        <p className="mt-4">
                            Crucially, <strong>we do not store the raw data by default.</strong> The protocol stores the <em>hash</em> of the reasoning on our immutable ledger. The raw text remains in your private storage (S3/Blob). In the event of an audit, you can prove the integrity of your logs by regenerating the hash and matching it against the iya ledger.
                        </p>
                        ...
                        <p>
                            The iya protocol is engineered to satisfy the rigorous requirements of modern AI legislation:
                        </p>
                        <ul className="list-disc pl-6 space-y-2 mt-4 text-neutral-400">
                            <li><strong>EU AI Act (Article 12):</strong> Mandates "automatic recording of events" to ensure traceability of functioning. iya's immutable ledger satisfies this by design.</li>
                        ...
                        <p>
                            We reject the "Platform" approach. iya is not a hosting provider. We are an infrastructure layer.
                        </p>
                        <p className="mt-4">
                        ...
                        <p className="mt-4">
                            ...
                            Because we rely on hashing and local signing, sensitive PII/PHI never needs to leave your VPC. The Project Governance cloud receives only metadata and cryptographic proofs, ensuring you remain compliant with GDPR and HIPAA data residency requirements.
                        </p>

                        <h2 className="text-2xl font-medium text-white mt-12 mb-6">6. Future Outlook</h2>
                        <p>
                            As the ecosystem matures, iya is committed to supporting open standards. We are actively integrating with the <strong>Model Context Protocol (MCP)</strong> to standardize how agents discover and authenticate with resources.
                        </p>
                        <p className="mt-4">
                        ...
                        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
                            <span className="text-neutral-500 font-mono text-sm">© 2026 iya</span>
                            <Link href="/" className="text-white text-sm font-bold uppercase tracking-widest border border-white/20 px-6 py-3 rounded-full hover:bg-[#FF7F50] hover:border-[#FF7F50] hover:text-white transition-all duration-300 shadow-[0_0_20px_rgba(255,127,80,0)_inset] hover:shadow-[0_0_20px_rgba(255,127,80,0.4)_inset]">
                                Start Integration
                            </Link>
                        </div>
                    </div>
